...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/hebrew-gematria-reference-chart-2026`, lastModified: now, changeFrequency: "yearly", priority: 0.8 },
    { url: `${BASE_URL}/english-to-hebrew-gematria`, lastModified: now, changeFrequency: "yearly", priority: 0.8 },
    { url: `${BASE_URL}/english-gematria-value-chart`, lastModified: now, changeFrequency: "yearly", priority: 0.8 },
