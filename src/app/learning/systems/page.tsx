    ...
    >
      ...
      <div className="border border-border rounded-xl p-6">
        ...
        <div className="bg-muted/50 rounded-lg p-4 text-sm">
          ...
          <p className="text-muted-foreground">The same word can have a different total under Mispar Gadol if it contains a final letter form, which opens additional layers of interpretation.</p>
        </div>
      </div>
    </NextModuleLayout>
  );
