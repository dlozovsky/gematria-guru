    ...
    >
      <div className="border border-border rounded-xl p-6">
        ...
        <div className="bg-muted/50 rounded-lg p-4 text-sm">
          ...
          <p className="text-muted-foreground">The prophet Jeremiah uses AtBash in Jeremiah 25:26, where "Sheshach" (ששך) is the AtBash encoding of "Babel" (בבל), a veiled reference to Babylon.</p>
        </div>
      </div>
      <div className="border border-border rounded-xl p-6">
