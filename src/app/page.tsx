      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 w-full max-w-3xl mx-auto flex flex-col items-center justify-start px-4 py-8">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-2">
            Free Gematria Calculator for Hebrew, English and Greek
          </h1>
          ...
          <section className="w-full mb-8">
            ...
            <div className="space-y-3 text-muted-foreground text-sm">
              ...
              <p>
                ...
                operation, and the results here are reproducible. Every table and worked example on
                this page is generated by the same code that computes your result. What a given number
